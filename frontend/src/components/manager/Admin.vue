  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" stripe @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="id" label="用户名" width="70" align="center" sortable/>
    ...
    >
      ...
      <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
        <el-form-item label="用户名" prop="id">
          <el-input v-model="form.id" placeholder="用户名"></el-input>
        </el-form-item>
...
const isHandleAdd = ref(false); // 判断是编辑还是新增
const form = reactive({});
